...
class GardenGeneralPosts extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$post_metakey = $instance['thmetakey'];
		$post_metavalue = $instance['thmetavalue'];
        ...
        echo apply_filters('wpr_adjust_genposts_beforewidget', $before_widget, $post_widgeid, $post_widgeclass);		
        ...
        echo apply_filters('wpr_adjust_genposts_afterwidget', $after_widget, $post_widgeid, $post_widgeclass);	
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['thmetakey'] = strip_tags( $new_instance['thmetakey']);
		$instance['thmetavalue'] = strip_tags( $new_instance['thmetavalue']);
	...
	// outputs the options form on admin
		$defaults = array( 'title' => 'General Posts', 'show' => '3', 'orderby'=> 'date', 'order'=>'DESC', 'catin' => '', 'catout' => '', 'pagecount' => '3', 'taxis' => '', 'taxterm' => '', 'ptipe' => 'post', 'thmetakey'=> '', 'thmetavalue' => '', 'metacompare' => '=', 'widgetidentifier' => '', 'widgetclassifier' => '', 'readmoretitle' => '', 'readmorelink' => '');//'term' => ' ', 
		...
		Meta Key: <input class="widefat" name="<?php echo $this->get_field_name( 'metakey' ); ?>" value="<?php echo $post_metakey; ?>" />
		<br/>
